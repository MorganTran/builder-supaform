...
export const ReactTypescriptTutorial: FC<ReactTutorialProps> = memo(({ formId }) => {
...
export const CompForm = () => {
    ...
    const handleSummit = useCallback((submission: Submission) => {
    ...
    return (
        <Form onSubmit={handleSummit} onFormReady={handleFormReady}  src={formDefination as unknown as FormType}/>
    );
}
...
export default ReactTypescriptTutorial